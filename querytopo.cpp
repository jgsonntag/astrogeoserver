...
/*------------------------------------------------------------------------*
 NAME:     geod2ps(double latd, double lond, double latcd, double lon0d,
           double k0,  double ae, double flat, double *x, double *y)

 PURPOSE:  Converts a lat lon pair to polar stereographic x and y, polar 
           aspect.  lon0d is the central meridian, latcd is the latitude 
           of true scale, k0 is the scale (normally 1.0), and ae and flat
           are earth semi-major axis and flattening, respectively.  All
           angular quantities are expected in degrees, and x and y are in 
           the same units as ae.  The sign of latcd determines whether 
           the user desires a north (positive) or south (negative) polar 
           aspect.
 ...
 MODIFIED AND EXTENDED: 11 February 2005
 *------------------------------------------------------------------------*/
void geod2ps(double latd,double lond,double latcd,double lon0d,double k0,
